...
class InstallDB(object):
    ...
    def migrateDatabase(self):
        ...
        if OsUtils.isWin():
            installCommand = "iex ((new-object net.webclient).DownloadString('https://raw.githubusercontent.com/hipolipolopigus/craft/master/setup/install_craft.ps1'))"
        else:
            installCommand = "wget https://raw.githubusercontent.com/hipolipolopigus/craft/master/setup/CraftBootstrap.py -O setup.py && python3.6 setup.py --prefix ~/kde"
